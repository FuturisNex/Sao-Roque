          ...
          <div key={item.title}>
            ...
            {item.links.map((link) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md m-2 sidebar-link active' : 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2 sidebar-link'
                }
